...
namespace Gringotts.Api.Features.LogReader.Endpoints.Readers;
...
public class UpdateReaderEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut("readers/{id:guid}",
                ...
                await EndpointHelpers.UpdateEntity<Models.LogReader, UpdateReaderResponse>(
                    id,
                    dbContext,
                    updateEntity: reader =>
                    {
            ...
            .WithEntityExistenceFromRouteFilter<Models.LogReader>("id")

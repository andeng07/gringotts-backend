...
{
    public async Task<TypedOperationResult<Models.Reader>> CreateReaderAsync(string name, Guid location)
    {
        ...
        return TypedOperationResult<Models.Reader>.Success(reader);
    }

    public async Task<TypedOperationResult<Models.Reader>> GetReaderById(Guid id)
    {

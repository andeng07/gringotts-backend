...
public class LoginManagementUserEndpoint : IEndpoint
{
    ...
    {
        var passwordCheckResult = await managementUserSecretService.MatchSecretAsync(request.Username, request.Password);

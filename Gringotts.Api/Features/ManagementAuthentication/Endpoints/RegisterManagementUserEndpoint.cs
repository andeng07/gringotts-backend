...
namespace Gringotts.Api.Features.ManagementAuthentication.Endpoints;
...
public class RegisterManagementUserEndpoint : IEndpoint
{
    ...
    public static async Task<IResult> HandleAsync(
        ...
        ManagementUserSecretService managementUserSecretService,
        ManagementUserService managementUserService,
        CancellationToken cancellationToken
    )
    {
        // Check if the email is already registered
        if (await managementUserSecretService.HasSecretAsync(request.Username))
        {
        ...
        // Create user
        var registeredUserResult = await managementUserService.CreateUserAsync(
            request.FirstName,
            request.LastName,
            request.MiddleName
        );
        ...
        var createSecretResult = await managementUserSecretService.CreateSecretAsync(
        ...
        var response = new RegisterUserResponse(registeredUserResult.Value.Id, createSecretResult.Value!.Username);

...
namespace Gringotts.Api.Migrations
{
    ...
    [Migration("20241227050830_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gringotts.Api.Features.Auth.Models.ReaderSecret", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Gringotts.Api.Features.Log.Models.Record", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Gringotts.Api.Features.Auth.Models.ReaderSecret", b =>
                {
                    b.HasOne("Gringotts.Api.Features.Reader.Models.Reader", null)
                        .WithOne()
                        .HasForeignKey("Gringotts.Api.Features.Auth.Models.ReaderSecret", "ReaderId")
